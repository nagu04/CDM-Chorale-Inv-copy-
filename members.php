...
<body>
    ...
    for (var i = 0; i < editBtns.length; i++) {
        editBtns[i].onclick = function() {
            ...
            document.getElementById("editLastName").value = memberName.split(', ')[0];
            document.getElementById("editGivenName").value = memberName.split(', ')[1];
            document.getElementById("editMiddleInitial").value = memberName.split(' ')[1] ? memberName.split(' ')[1].charAt(0) : '';
            document.getElementById("editExtension").value = memberName.split(' ')[2] ? memberName.split(' ')[2] : '';
